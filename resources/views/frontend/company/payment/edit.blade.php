    ...
    <div class="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 py-10 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-10">
                <h1 class="text-3xl font-bold text-primary-500 mb-2">Edit Your Bank Detail</h1>
                <p class="text-gray-600">Fill out the form below to edit your bank detail.</p>
            </div>

            <!-- Form -->
            <form action="{{ route('paymentupdate', $bankDetail->id) }}" method="POST" class="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
                @method('PUT')
                @csrf
