    ...
    <div class="relative z-10 max-w-5xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <div class="mt-4">
                ...
                <span class="text-primary-700 text-xl font-bold">Dawn in Nepal</span>
            </div>
    @auth
            <div class="float-right">
                <a href="{{ route('termsandconditioncreate') }}">
                    <button class="bg-primary-500 p-2 text-white rounded-md hover:bg-primary-300 hover:text-gray-900">Add Terms</button>
                </a>
