        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600 mt-6">
                    Fill out the form below to add a new member to our amazing team.
                </p>
            </div>

            <!-- Create Team Member Form -->
            <form class="bg-white rounded-2xl shadow-lg p-8 sm:p-12" method="POST" action="{{ route('teamstore') }}" enctype="multipart/form-data">
                @csrf
                <!-- Name Field -->
                <div class="mb-8">
