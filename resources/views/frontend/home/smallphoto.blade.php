...
<div class="bg-gradient-to-br from-blue-50 to-indigo-50 ">
  ...
  <div class="mx-auto px-4 py-8 container w-[85%] ">
    <!-- Heading -->
        ...
        <div class="relative flex items-center">
          ...
          <div class="carousel overflow-hidden w-full">
            <div class="carousel-inner flex transition-transform duration-300">
              <!-- Cards -->
              <div id="webcrumbs" class="font-sans text-base">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                    @foreach ($regions as $region)
                    <a href="{{ route('regionsshow', $region->id)}}">
                      <div class="rounded-[4rem] bg-gradient-to-br from-blue-50 to-blue-100 p-6 shadow-xl transition-all hover:shadow-2xl hover:-translate-y-1 hover:ring-4 hover:ring-blue-100/50">
                        <div class="relative group">
                          <div class="relative overflow-hidden rounded-[4rem]">
                            <div class="absolute inset-0 bg-gradient-to-t from-blue-800/30 to-transparent z-10"></div>
                            <img
                          ...
                          <div class="mt-4 text-center">
                            <div class="inline-block backdrop-blur-sm px-6 py-2 rounded-full shadow-inner shadow-blue-100">
                              <h2 class="text-3xl font-black bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 bg-clip-text text-transparent">
                                {{ $region->name }}
                              </h2>
                            </div>
                          </div>
                          <div class="absolute -top-4 -left-4 h-24 w-24 rounded-full bg-blue-400/10 blur-xl"></div>
                          <div class="absolute -bottom-4 -right-4 h-24 w-24 rounded-full bg-blue-600/10 blur-xl"></div>
                        </div>
                      </div>
                    </a>
