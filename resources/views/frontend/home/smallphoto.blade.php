...
<div class="bg-gradient-to-br from-blue-50 to-indigo-50 ">
  ...
  <div class="mx-auto px-4 py-8 container w-[90%] ">
      <!-- Heading -->
      <h1 class="text-center text-gray-800 text-4xl font-bold mb-10 xl:mt-10 lg:mt-8 mt-4service_card">Travel the Nepal
          Your Way</h1>
      ...
      <div class="space-y-8">
          ...
          <div class="carousel-container service_card">
              ...
              <div class="relative flex items-center">
                  <!-- Left Button -->
                  <button
                      class="carousel-left-btn absolute top-1/2 left-1 sm:-left-12 transform -translate-y-1/2 bg-white border-2 border-gray-300 rounded-full p-2 shadow-2xl hover:scale-110 transition-all duration-300 z-10 flex items-center justify-center text-lg sm:text-xl">
                  ...
                  <div class="carousel overflow-hidden w-full">
                      <div class="carousel-inner flex transition-transform duration-300">
                          ...
                          @foreach ($regions as $region)
                              <div
                                  class="card service_card1 bg-white border-2 border-gray-300  card text-gray-700 shadow-xl rounded-lg p-2 flex-shrink-0 xl:w-1/5 lg:w-1/4 md:w-1/3 sm:w-1/2 w-full flex items-center transform hover:scale-105 hover:shadow-lg mx-2">
                                  <img src="{{ asset('images/regions/' . $region->image) }}" alt="Image"
                  ...
                  <!-- Right Button -->
                  <button
                      class="carousel-right-btn absolute top-1/2 right-2 xs:-right-5 sm:-right-12 transform -translate-y-1/2 bg-white border-2 border-gray-300 rounded-full p-2 shadow-lg hover:scale-110 transition-all duration-300 z-10 flex items-center justify-center text-lg sm:text-xl">
                  ...
                  <div class="carousel overflow-hidden w-full">
                      <div class="carousel-inner flex transition-transform duration-300">
                          ...
                          @foreach ($tours as $tour)
                              <div
                                  class="service_card1 bg-white card shadow-lg border-2 border-gray-300 rounded-md p-2  flex-shrink-0 xl:w-1/5 lg:w-1/4 md:w-1/3 sm:w-1/2 w-full flex items-center transform hover:scale-105 hover:shadow-lg mx-2">
                                  <img src="{{ asset('images/tours/' . $tour->image) }}" alt="Image"
                                      class="w-10 h-10 object-cover rounded-md mr-2">
                  ...
                  <div class="carousel overflow-hidden w-full">
                      <div class="carousel-inner flex transition-transform duration-300">
                          ...
                          @foreach ($expeditions as $expedition)
                              <div
                                  class="service_card1 bg-white card shadow-lg border-2 border-gray-300 rounded-md p-2 flex-shrink-0 xl:w-1/5 lg:w-1/4 md:w-1/3 sm:w-1/2 w-full flex items-center transform hover:scale-105 hover:shadow-lg mx-2">
                                  <img src="{{ asset('images/expeditions/' . $expedition->image) }}" alt="Image"
                                      class="w-10 h-10 object-cover rounded-md mr-2">
