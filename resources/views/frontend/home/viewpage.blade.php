...
<div class="relative h-screen ">
        ...
        <div class="relative xs:w-full w-[80%]  flex justify-center px-2 sm:px-4 ">
            <div
                ...
                <button
                    ...
                    onclick="toggleModal()" aria-label="Open search modal hidden" >
    ...
    <div class="absolute top-1/2 -translate-y-1/2 right-2 xs:right-4  flex-col space-y-2 xs:space-y-4  flex ">
        ...
        <!-- Email -->
        <a title="" href="" class="bg-gray-100 p-1 sm:p-2 rounded-full text-white shadow-lg hover:bg-gray-300 transition text-center overflow-hidden">
        ...
        <img src="{{ asset('images/tripsadvisor.png') }}" alt="TripAdvisor"
            class="w-8 h-12 sm:w-8 sm:h-8 md:w-8 md:h-8" loading="lazy">
    </a>
