{{-- <div class="relative h-screen">
    ...
    <div class="relative flex flex-col items-center justify-center h-full text-center text-white">
        <div>
            <h1 id="typing-text" class="notranslate text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold xl:mb-6 lg:mb-4 mb-3 text-white" style="font-family: 'Playwrite Australia SA';">
                <!-- Add heading text here -->
            </h1>
        </div>
        <div class="relative w-full flex justify-center px-2 sm:px-4">
            <div class="flex items-center w-full max-w-xs sm:max-w-lg md:max-w-xl lg:max-w-2xl bg-white rounded-full shadow-lg overflow-hidden">
                ...
                <button 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="absolute top-1/2 -translate-y-1/2 right-2 xs:right-4 flex flex-col space-y-2 xs:space-y-4 hidden xs:flex">
        <!-- WhatsApp -->
        <a href="https://whatsapp.com" target="_blank" 
           class="bg-green-600 p-1 sm:p-2 rounded-full shadow-lg text-white hover:bg-gray-100 hover:text-green-600 transition">
            <i class="fab fa-whatsapp text-xl sm:text-2xl md:text-3xl"></i>
        </a>

        <!-- Facebook -->
        <a href="https://facebook.com" target="_blank" 
           class="bg-blue-700 p-1 sm:p-2 rounded-full text-white shadow-lg hover:bg-gray-100 hover:text-blue-700 transition">
            <i class="fab fa-facebook text-xl sm:text-2xl md:text-3xl"></i>
        </a>

        <!-- Instagram -->
        <a href="https://instagram.com" target="_blank" 
           class="bg-pink-600 p-1 sm:p-2 rounded-full text-white shadow-lg hover:bg-gray-100 hover:text-pink-600 transition">
            <i class="fab fa-instagram text-xl sm:text-2xl md:text-3xl"></i>
        </a>

        <!-- Twitter -->
        <a href="https://twitter.com" target="_blank" 
           class="bg-blue-500 p-1 sm:p-2 rounded-full text-white shadow-lg hover:bg-gray-100 hover:text-blue-500 transition">
            <i class="fab fa-twitter text-xl sm:text-2xl md:text-3xl"></i>
        </a>
    </div>
</div>
...
<div id="searchModal" class="hidden fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center transition-opacity duration-300 opacity-0 transform scale-90">
    <div class="relative bg-cover bg-center rounded-2xl shadow-xl w-11/12 max-w-3xl p-4 sm:p-6 md:p-12 text-gray-700 animate-fade-in" style="background-image: url('{{ asset('frontend/images/mountain.png') }}')">
        ...
        <div class="relative z-10 text-white">
            ...
            <p class="text-gray-300 text-xs sm:text-sm md:text-base mb-6 text-center">Discover amazing adventures tailored just for you.</p>
...
<div class="relative h-screen">
    ...
    <div class="absolute top-1/2 -translate-y-1/2 right-2 xs:right-4  flex-col space-y-2 xs:space-y-4  flex">
        ...
        <!-- Email -->
        <a title="" href="mailto:dawninnepal3@gmail.com" class="bg-gray-100 p-1 sm:p-2 rounded-full text-white shadow-lg hover:bg-gray-300 transition text-center">
        ...
        <a href="https://www.tripadvisor.com/Attraction_Review-g293890-d10089624-Reviews-Dawn_In_Nepal_Adventures_Pvt_Ltd-Kathmandu_Kathmandu_Valley_Bagmati_Zone_Central.html"
            ...
            <img src="https://static.tacdn.com/img2/brand_refresh/Tripadvisor_logomark.svg" alt="TripAdvisor"
                class="w-6 h-6 sm:w-8 sm:h-8 md:w-8 md:h-8">
        </a>
    </div>
</div>
