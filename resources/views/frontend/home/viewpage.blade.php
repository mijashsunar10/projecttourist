<section class="bg-gray-100 service_card">
  ...
  <div class="container mx-auto px-4 py-10 relative" style="width: 90%">
      ...
      <div class="relative group py-6">
          ...
          <div id="carousel" class="flex overflow-x-auto space-x-6 scrollbar-hide snap-x snap-mandatory scroll-smooth px-4 transition-all duration-700">
              ...
              <a href="#" class="flex-shrink-0 snap-center w-full sm:w-1/2 md:w-1/3 transition-transform duration-700 ease-in-out transform hover:scale-105">
                  <div class="service_card1 overflow-hidden bg-white rounded-lg shadow-lg hover:shadow-2xl">
                      <img src="{{asset('frontend/images/featurecard/image copy.png')}}" alt="Trek Image" class="w-full h-48 object-cover transition-transform duration-300 hover:scale-110">
                      <div class="p-4">
          ...
          <button id="leftArrow" class="absolute top-1/2 -left-10 transform -translate-y-1/2 bg-blue-600 text-white rounded-full p-4 hover:bg-blue-500 shadow-lg transition-all duration-300 z-10">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
              </svg>
          </button>
          <button id="rightArrow" class="absolute top-1/2 -right-10 transform -translate-y-1/2 bg-blue-600 text-white rounded-full p-4 hover:bg-blue-500 shadow-lg transition-all duration-300 z-10">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
