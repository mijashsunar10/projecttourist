<div class="relative h-screen">
    ...
    <div class="relative flex flex-col items-center justify-center h-full text-center text-white">
        <div>
            <h1 id="typing-text"
                class="notranslate text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold xl:mb-6 lg:mb-4 mb-3 text-white"
    ...
    <div class="absolute top-1/2 -translate-y-1/2 right-2 xs:right-4  flex-col space-y-2 xs:space-y-4 hidden xs:flex">
        <!-- WhatsApp -->
        ...
        <a title="" href="mailto:dawninnepal3@gmail.com"   class="bg-gray-100 p-1 sm:p-2 rounded-full text-white shadow-lg hover:bg-gray-300 transition text-center">
            <img width="32" alt="Gmail icon" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Gmail_icon_%282020%29.svg/512px-Gmail_icon_%282020%29.svg.png?20221017173631" class="">
        </a>
