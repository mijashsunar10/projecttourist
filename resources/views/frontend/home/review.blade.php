<!-- Homepage Blade Template (frontend.homepage) -->
        ...
        <div class="my-10">
            ...
            @if ($latestReviews->count() > 0)
                ...
                <div class="mt-8 text-center">
                    <a href="{{ route('all.combined.reviews') }}" class="inline-block px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition duration-200 ease-in-out">
                        View All Reviews
                    </a>
                </div>
            @else
