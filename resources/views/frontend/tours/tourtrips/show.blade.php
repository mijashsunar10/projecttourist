...
<div class="sticky top-20 z-10 bg-primary-700 shadow hidden md:block  ">
    <nav class="container flex justify-center items-center py-4 px-6">
        <ul class="flex space-x-16 text-white">
            <li><a href="#tripfacts" class="nav-link hover:text-secondary-500">Mountain Facts</a></li>
            <li><a href="#overview" class="nav-link hover:text-secondary-500">Overview</a></li>
            <li><a href="#highlight" class="nav-link hover:text-secondary-500">Trip Highlights</a></li>
            <li><a href="#itinerary" class="nav-link hover:text-secondary-500">Itinerary Overview</a></li>
            <li><a href="#required" class="nav-link hover:text-secondary-500">Required Items</a></li>
            <li><a href="#inclusions" class="nav-link hover:text-secondary-500">Included & Excluded</a></li>

            <li><a href="#faqs" class="nav-link hover:text-secondary-500">FAQS</a></li>
            <li><a href="#reviews" class="nav-link hover:text-secondary-500">Reviews</a></li>
    ...
    <div class="bg-gray-100 h-[80vh] mt-20 w-full mx-auto flex items-center justify-center overflow-hidden relative ">
        <div class="w-full text-center h-full relative ">
            ...
            <img id="main-image"
                ...
                alt="Main Image"
                class="h-full w-full object-cover shadow-lg z-0 transition-opacity duration-500 ease-in-out opacity-100 overflow-hidden" />
...
<div class="container  px-8 py-12 flex gap-6 flex-col md:flex-row">
    ...
    <div class="md:w-4/5 w-full">
        ...
        <div class="flex flex-col items-center justify-center ">
            ...
            <div class="flex items-center w-full max-w-4xl  mt-6">
                ...
                <h1 class="text-2xl md:text-3xl lg:4xl font-bold text-gray-600 mx-8 text-center uppercase whitespace-nowrap text-wrap" style="font-family:'Times New Roman', Times, serif">
                    {{ $tourtrip->name }}
                </h1>
                <div class="flex-1 border-t-2 border-[#0b3e85]"></div>
            </div>
        ...
        <div class="bg-white xl:p-12 p-8 rounded-lg shadow-lg mt-6" id="overview">
            <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Trip Overview</h2>
        ...
        <section class="container   py-8 px-16 bg-white shadow-xl rounded-lg  mt-8 hover-scale" id="tripfacts">
            ...
            <a href="{{ route('tourfactcreate', $tourtrip->id) }}">
                <button class="bg-primary-700 text-white px-4 py-2 rounded mb-5">Add Tour Fact</button>
            </a>
            @endauth


            <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Tour Facts</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="flex items-center space-x-3">
                    <div>
                        <svg width="64px" height="64px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#0B6285" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.144"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path d="M12 8V12L14.5 14.5" stroke="#0B6285" stroke-width="1.8960000000000001" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="#0B6285" stroke-width="1.8960000000000001" stroke-linecap="round"></path>
                            </g>
                        </svg>
                    </div>
                    <div>
                ...
                <div class="flex items-center space-x-4">
                    <div>
                        <svg fill="#0B6285" height="64px" width="64px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 612 612" xml:space="preserve" stroke="#0B6285" stroke-width="0.0061200000000000004">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    ...
                    <div>
                        <svg fill="#0B6285" width="64px" height="64px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" id="airport" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" stroke="#0B6285" stroke-width="0.00512">
                            ...
                            <g id="SVGRepo_iconCarrier">
                                ...
                                <polygon points="419.254,236.323 419.254,218.005 354.796,218.005 354.796,236.323 354.796,239.097 419.254,239.097 "></polygon>
                                <path d="M57.354,89.034c0.938,1.525,2.202,2.84,3.653,3.888l57.412,41.479l16.448,97.619c0.655,3.888,2.64,7.429,5.614,10.018 l10.22,8.895c2.755,2.399,7.056,0.462,7.085-3.191l0.68-84.406l57.237,41.354c13.063,9.438,30.591,9.853,44.086,1.043l22.049-14.393 c2.505-1.635,2.968-5.115,0.979-7.348l-2.428-2.727c-4.456-5.003-11.213-7.298-17.794-6.042l-25.207,4.81l-116.816-99.23 c-11.382-9.669-25.806-15.337-40.738-15.125c-4.75,0.068-9.725,0.696-14.664,2.202c-8.892,2.711-12.791,12.814-8.03,20.799 C57.21,88.796,57.282,88.915,57.354,89.034z"></path>
                                <path d="M187.879,123.313c3.513,3.129,8.112,4.758,12.812,4.537l61.257-2.879c2.973-0.667,3.793-4.513,1.354-6.336l-9.051-6.761 c-2.634-1.968-5.868-2.961-9.152-2.81l-73.858-8.1c-2.998-0.329-4.649,3.386-2.397,5.392L187.879,123.313z"></path>
                            </g>
                        </svg>
                    </div>
                    <div>
                ...
                <div class="flex items-center space-x-3">
                    <div>
                        <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path d="M18 16.0156C19.2447 16.5445 20 17.2392 20 18C20 19.6568 16.4183 21 12 21C7.58172 21 4 19.6568 4 18C4 17.2392 4.75527 16.5445 6 16.0156" stroke="#0B6285" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
                                <path d="M17 8.44444C17 11.5372 12 17 12 17C12 17 7 11.5372 7 8.44444C7 5.35165 9.23858 3 12 3C14.7614 3 17 5.35165 17 8.44444Z" stroke="#0B6285" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
                                <circle cx="12" cy="8" r="1" stroke="#0B6285" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></circle>
                            </g>
                        </svg>
                    </div>
                    <div>
                ...
                <div class="flex items-center space-x-3">
                    <div>
                        <svg version="1.1" id="mountain" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="64px" height="64px" viewBox="0 0 256 256" xml:space="preserve" fill="#000000">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <style type="text/css">
                ...
                <div class="flex items-center space-x-3">
                    <div>
                        <svg fill="#0B6285" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="64px" height="64px" viewBox="924 565.952 200 200" enable-background="new 924 565.952 200 200" xml:space="preserve">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <g>
                ...
                <div class="flex items-center space-x-3">
                    <div>
                        <svg fill="#0B6285" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 128 85.2" xml:space="preserve" stroke="#0B6285">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <g>
                                    <g>
                                        ...
                                        <g>
                                            <path d="M41,25.9v9.8H23.6c-8.4,0-8.4,10.9,0,10.9h22.9c3.3,0,5.4-2.7,5.4-5.7v-15C51.9,17.7,41,17.7,41,25.9z"></path>
                                        </g>
                                        <g>
                                            <path d="M15.3,10.6c0-8.9-12.4-8.9-12.4,0v71.6h12.7V63.7H112v18.4h12.4V26.7c0-9.4-12.5-9.4-12.5,0v22.1H15.3V10.6z"></path>
                                        </g>
                                    </g>
                                </g>
                            </g>
        ...
        <section id="highlight">
            ...
            <div class=" mt-8 p-6 bg-white rounded-lg shadow-xl">
                ...
                <div style="max-width: 95%" class="">
                    <h2 class="md:text-3xl text-2xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Tour Highlights</h2>
                    ...
                    <div class="mt-6 flex space-x-4">
                        <a href="{{ route('tourHighlightsedit', $tourtrip->id) }}" class="bg-primary-700 text-white px-6 py-2 rounded-md hover:bg-blue-600 transition-colors duration-300">
                            Edit Highlights
                        </a>
                        <a href="{{ route('tourHighlightscreate', $tourtrip->id) }}" class="bg-primary-300 text-white px-6 py-2 rounded-md hover:bg-green-600 transition-colors duration-300">
                            Add Highlights
                        </a>
                    </div>
                </div>
        ...
        <h2 class=" text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Tour Highilights</h2>
        ...
        <div class="mt-6">
            ...
            <section class="bg-gray-100 mt-8 p-9 " id="itinerary">
                ...
                <div class=" " style="max-width:95%">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Tour Iterinary Overview</h2>

                    <div class="flex items-center justify-center" style="max-width:95%">
                        <div class="w-full max-w-7xl">
                            <div class="bg-primary-700 text-white text-center my-6 p-6 rounded-t-lg">
                                <h1 class="text-2xl sm:text-3xl font-bold" style="font-family: 'Times New Roman', Times, serif">Tours in Nepal – Iterinanary Overview</h1>
                            ...
                            <div id="faq-container" class="bg-transparent shadow-lg rounded-b-lg">
                                ...
                                <div class="border-b mb-4 last:mb-0">
                                    <button
                                        class="w-full flex justify-between items-center text-left p-4 text-lg font-semibold text-primary-700 bg-white focus:outline-none shadow-md"
        ...
        <section id="required">
            <div class="container  py-20 px-8 bg-white rounded-lg shadow-lg mt-8">
                <div class="" style="max-width: 95%">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Required Items for This Tour</h2>
                    ...
                    @auth
                    <a href="{{ route('tourrequireditemscreate', $tourtrip->id) }}" class="mt-6 inline-block bg-primary-700 text-white px-4 py-2 rounded">Add Required Item</a>
                    @endauth
                </div>
            </div>
            <script>
        ...
        <div class="container  py-6 px-12 bg-gray-100 mt-8" id="inclusions">
            <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Tour Inclusionn and Exclusion </h2>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('tourtrips.inclusions-exclusions.create', $tourtrip->id) }}" class="bg-primary-700 text-white px-4 py-2 rounded shadow-md">Add Items</a>
            </div>
            @endauth
        </div>
        ...
        <div class="mt-6">
            ...
            <div class="bg-gray-100 mt-8 p-9 " id="faqs">
                ...
                <div class="mx-auto " style="max-width:95%">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Tour FAQ Overview</h2>
                    <div class="flex items-center justify-center" style="max-width:95%">
                        <div class="w-full max-w-7xl">
                            <div class="bg-primary-700 text-white text-center my-6 p-6 rounded-t-lg">
                                {{-- <h1 class="text-4xl font-bold">Tours in Nepal – Tour Faq Overview</h1> --}}
                                <h2 class="text-2xl sm:text-3xl font-bold  text-white" style=" font-family: 'Times New Roman', Times, serif">Tours in Nepal – TOur Faq Overview</h2>
        ...
        <div class="bg-gray-100  mt-6 p-10  ">
            <div class="">
                <h2 class=" text-2xl sm:text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Latest Review</h2>
                ...
                <div class="mt-8 text-center">
                    <a href="{{ route('tourreviews.index', $tourtrip_id) }}" class="inline-block px-6 py-2 bg-primary-700 text-white rounded-md hover:bg-blue-600 transition duration-200 ease-in-out">
                        View All Reviews
                    </a>
                </div>
            </div>
        ...
        <div class="container  py-8 px-12 mx-auto bg-gray-100 rounded-lg shadow-lg mt-10">
            <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-primary-700" style=" font-family: 'Times New Roman', Times, serif">Write a Review</h2>
            <form action="{{ route('tourreviews.store', $tourtrip->id) }}" method="POST" enctype="multipart/form-data" class="bg-white  p-8 rounded-lg shadow-md" style="max-width:95%">
                ...
                <div class="mt-6 text-center">
                    <button type="submit" class="px-8 py-3 bg-primary-700 text-white rounded-lg hover:bg-blue-600 transition duration-200 ease-in-out">
                        Submit Review
                    </button>
                </div>
            </form>
    ...
    <div class="md:w-1/5 sticky top-40 h-max w-full">
