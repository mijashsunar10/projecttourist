...
<section class="bg-gradient-to-b from-gray-50 to-gray-100 py-12">
    ...
    @auth
    <div class="flex flex-col items-center justify-center  mt-6 pb-2">
        ...
        <div class="flex items-center w-full max-w-4xl mx-auto mt-6">
            ...
            <h1 class="text-2xl  md:text-3xl  font-bold text-[#753f0e] mx-4 sm:mx-8 text-center uppercase whitespace-nowrap text-wrap">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-[90%] mx-auto p-6">
        ...
        <div class="relative overflow-hidden rounded-2xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] group h-96 transform transition-transform duration-300 hover:scale-105">
            <a href="{{ route('tourshow', $tour->id) }}">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center text-white font-bold space-y-2 text-center p-6 bg-gradient-to-t from-black/60 to-transparent">
                    ...
                    <div class="flex justify-between mt-4 p-2 space-x-4 w-full">
                        <a href="{{ route('tourshow', $tour->id) }}" class="bg-primary-300 text-white px-6 py-2 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex-1 text-center">
                            Views Trips
                        </a>
        ...
        <style>
        /* Custom animation for card hover effect */
        .card {
