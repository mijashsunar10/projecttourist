...
<div class="container mx-auto mt-20 p-6 bg-white rounded-lg shadow-lg max-w-7xl relative">
    ...
    <a href="{{ route('mountainshow', $mountainId) }}" class="absolute top-4 right-4 text-gray-500 hover:text-red-600 transition text-2xl">
        ❌
    </a>

    <h2 class="text-3xl font-bold text-blue-700 mb-8 text-center">Add Inclusions & Exclusions</h2>
    
    <form action="{{ route('mountains.inclusions-exclusions.store', $mountainId) }}" method="POST" class="space-y-6">
        @csrf
