...
<div class="container mx-auto py-8 px-16 bg-white shadow-md rounded-lg mt-20">
    <h2 class="text-3xl font-bold text-blue-700 mb-6">Add mountain Fact for {{ $mountain->name }}</h2>
    <form action="{{ route('mountainfactstore', $mountain->id) }}" method="POST">
        @csrf
        ...
        <div class="mt-6">
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded">Save mountain Fact</button>
