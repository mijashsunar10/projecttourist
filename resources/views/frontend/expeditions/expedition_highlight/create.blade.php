...
<div class="container mx-auto mt-10">
    <h1 class="text-2xl font-bold mb-4">Add Highlights for "{{ $mountain->name }}"</h1>

    <form action="{{ route('mountainHighlightsstore', $mountain->id) }}" method="POST">
        @csrf
        <div id="highlight-container" class="space-y-4">
            <textarea name="mountainhighlights[]" class="w-full border rounded px-4 py-2" placeholder="Highlight 1"></textarea>
        </div>
