...
{{-- mountain Facts --}}
<div class="px-8 py-12 flex flex-col lg:flex-row gap-6">
    ...
    <div class="flex flex-wrap items-center justify-center w-full max-w-4xl mx-auto xs:mb-4 mt-8 ">
        ...
        <div class="bg-white xl:p-12 p-8 rounded-lg shadow-lg mt-6" id="overview">
            <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Expedition Overview</h2>
        ...
        <div id="tripfacts" class="container   py-8 px-16 bg-white shadow-xl rounded-lg  mt-8 " >
            ...
            @endauth
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    @if ($mountainFacts->isEmpty())
                    <p class="text-gray-500">No mountain facts available for this mountain.</p>
                @else
                    @foreach ($mountainFacts as $fact)
                    ...
                    <div class="mt-2  w-full">
                        ...
                        <form action="{{ route('mountainfactdestroy', [$mountain->id, $fact->id]) }}" method="POST" class="inline-block">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded">Delete mountain Facts</button>
                        </form>
                    </div>
                    @endauth
...
{{-- Trip Highghlight --}}
        @auth
        <div class="mx-auto mt-8 p-6 bg-white rounded-lg shadow-xl" id="highlight" >
            ...
            <div style="max-width: 97%" class="mx-auto">
                <h2 class="text-2xl sm:text-3xl font-bold mb-4 text-blue-900 " style=" font-family: 'Times New Roman', Times, serif">Expedition Highlights</h2>
    ...
    <div class="bg-gray-50 p-6 sm:p-8 md:p-10 xl:p-12 rounded-lg shadow-lg mt-8  mx-auto " id="highlight">
            <h2 class="text-2xl md:text-3xl font-bold mb-6 text-blue-900 " style=" font-family: 'Times New Roman', Times, serif">Expedition Highlights</h2>
...
{{-- Expedition Iterinary --}}  
    ...
    <div class="mt-6" >
        ...
        <div class=" mx-auto" >
            <h2  class="text-2xl md:text-3xl font-bold mb-6 text-blue-900 " style=" font-family: 'Times New Roman', Times, serif">Expedition Itirenary Overview</h2>
            <div class="flex items-center justify-center" style="max-width:95%" >
                <div class="w-full ">
                    <div class="bg-blue-800 text-white text-center my-6 p-6 rounded-t-lg">
                        <h1 class="text-xl sm:text-2xl md:text-3xl font-bold"  style="font-family: 'Times New Roman', Times, serif">Mountains in Nepal – Iterinanary Overview</h1>
                    ...
                    <div id="faq-container" class="bg-transparent shadow-lg rounded-b-lg p-4">
                        @foreach ($itineraries as $itinerary)
                            <div class="border-b mb-4 last:mb-0">
                                  <button class="w-full flex justify-between items-center text-left p-4 text-base sm:text-lg font-semibold text-blue-900 bg-white hover:bg-gray-100 shadow-lg focus:outline-none transition duration-200"
 ...
 {{-- Expedition Iterinary --}}
  ...
  <div class="container mx-auto py-20 px-8 bg-white rounded-lg shadow-lg mt-8" id="required" >
    <div class="w-full">
    
        <h2 class="text-2xl md:text-3xl font-bold mb-6 text-blue-900 "  style=" font-family: 'Times New Roman', Times, serif">Required Items for This Expedition</h2>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b py-3">
            <p class="text-gray-700 text-md sm:text-lg font-semibold flex items-center">&#10148; <span class="px-3"> {{ $item->item_name }}</span>
                ...
                <div class="flex flex-wrap gap-2 mt-2 sm:mt-0">
                        <a href="{{ route('mountainrequireditemsedit', [$mountain->id, $item->id]) }}"  class="bg-blue-500 text-white px-3 py-1 rounded text-sm sm:text-base hover:bg-blue-600">Edit</a>
                        <form action="{{ route('mountainrequireditemsdestroy', [$mountain->id, $item->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
        ...
        @auth
        <div class="">
            <a href="{{ route('mountainrequireditemscreate', $mountain->id) }}"  class="mt-6 inline-block bg-green-500 text-white px-5 py-2 rounded text-sm sm:text-base hover:bg-green-600">Add Required Item</a>
        </div>
        @endauth
    </div> 
    </div>
...
<!-- mountain Inclusionn and Exclusion -->
    ...
    <div class="container mx-auto py-16 px-16 bg-gray-200 mt-8" id="inclusions" >
        {{-- <h2 class="text-3xl font-bold text-[#0B6285] mb-8"></h2> --}}

        <h2 class="text-2xl sm:text-3xl font-bold mb-6 text-blue-900 " style=" font-family: 'Times New Roman', Times, serif">Inclusions And Exclusions</h2>
        ...
        @auth
            <div class="mt-6 text-center">
                <a href="{{ route('mountains.inclusions-exclusions.create', $mountain->id) }}"  class="bg-blue-500 text-white px-6 py-2 rounded-md shadow-md w-full sm:w-auto inline-block hover:bg-blue-600 transition duration-300">Add Items</a>
            </div>
        @endauth
    </div>
...
<div class="mt-6" >
    ...
    <section class="  bg-gray-100 mt-8 p-6 md:p-9" id="faqs">
     ...
     <div class=" mx-auto" style="max-width:95%" >
        <h2 class=" font-bold mb-4 text-blue-900  text-2xl md:text-3xl" style=" font-family: 'Times New Roman', Times, serif">Expedition FAQ Overview</h2>
         
         <div class="flex justify-center md:justify-start">
             <div class="w-full ">
                 <div class="bg-blue-900 text-white text-center p-6 rounded-t-lg mb-2 sm:mb-4">
                     <h1 class="text-2xl md:text-3xl font-bold" style="font-family: 'Times New Roman', Times, serif">Expeditions in Nepal – Mountain Faq Overview</h1>
                     <p class="mt-2 text-lg">A detail description of mountain Faq</p>
 
                     @auth
                         <a href="{{ route('mountainfaqcreate', $mountain->id) }}">
                 ...
                 <div id="faq-container" class="bg-transparent   shadow-lg rounded-b-lg">
                     ...
                     <div class="border-2 mb-2 sm:mb-4 border-gray-100 ">
                             <button
                                 ...
                                 onclick="toggleAnswer('answer{{ $mountainfaq->id }}')" aria-expanded="false">
                                 {{ $mountainfaq->question }}
                                 <svg id="icon{{ $mountainfaq->id }}"
                                     class="ml-2 w-5 h-5 text-gray-800 transition-transform transform"
                                     xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                         d="M19 9l-7 7-7-7" />
                             ...
                             <div  class="hidden px-4 pb-4 bg-white text-black" id="answer{{ $mountainfaq->id }}">
                             <p class="text-sm md:text-base">{{ $mountainfaq->answer }}</p>
                                 
 
                             @auth
                             <div class="mt-2 flex flex-wrap gap-2">
                                     <a href="{{ route('mountainfaqedit',  [$mountain->id, $mountainfaq->id]) }}" class="text-blue-500">
...
<div class="bg-gray-50 p-10 mt-6" id="reviews">
    <div class="">
        <h2 class="text-3xl font-bold mb-4 text-blue-900" style="font-family: 'Times New Roman', Times, serif">Latest Reviews of {{$mountain->name}}</h2>

{{-- <div class="container mx-auto p-10  bg-gray-100 mt-10 rounded-lg shadow-lg"  id="reviews"> --}}
    {{-- <h2 class=" text-2xl sm:text-3xl font-bold text-gray-800 mb-8 text-center">Latest Reviews</h2> --}}
    {{-- <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Latest Reviews of {{$mountain->name}}</h2> --}}
    
    @if ($mountainreviews->isEmpty())
    ...
    @else
    {{-- @if ($mountainreviews->count() > 0) --}}
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            @foreach ($mountainreviews as $review)
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('mountainreviews.index', $mountain_id) }}" class="inline-block px-6 py-2 bg-blue-500 mb-2 text-white rounded-md hover:bg-blue-600 transition duration-200 ease-in-out">
                View All Reviews
            </a>
...
<div id="reviewFormContainer" class="container py-8 px-4 bg-gray-100 rounded-lg shadow-lg mt-10" style="display: none;">
    <h2 class=" text-2xl sm:text-3xl px-8 py-3 font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Give your Review for {{$mountain->name}}</h2>
    <form action="{{ route('mountainreviews.store', $mountain->id) }}" method="POST" enctype="multipart/form-data" class="bg-white mx-auto p-8 rounded-lg shadow-md" style="max-width:95%">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
...
<div class="w-full lg:w-1/5 mx-auto sticky top-40 h-max">
    <div class="bg-white p-6 rounded-lg shadow-xl">
        ...
        <div class="space-y-3 mt-4">
            <a href="{{route('booking',['mountain',$mountain->id])}}" class="block bg-blue-800 text-white text-center py-3 rounded-md hover:bg-blue-700 transition font-bold">
                Book Now  
