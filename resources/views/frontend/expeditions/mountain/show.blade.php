...
<div class="sticky top-20 z-10 bg-blue-200 bg-blue-800 shadow">
...
<div id="tripfacts" class="container   py-8 px-16 bg-white shadow-xl rounded-lg  mt-8 hover-scale" >
        ...
        <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Expedition Facts</h2>
        @auth
    ...
    @endauth
        ...
        @else
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <p class="text-sm text-gray-600">mountain Start and End</p>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <p class="text-sm text-gray-600">mountain Area</p>
            ...
            <div class="mt-2">
                ...
                <a href="{{ route('mountainfactedit', [$mountain->id, $fact->id]) }}">
                    <button class="bg-yellow-500 text-white px-4 py-2 rounded">Edit mountain Facts</button>
                </a>
...
{{-- Trip Highghlight --}}
        @auth
        <div class=" mt-8 p-6 bg-white rounded-lg shadow-xl" id="highlight" >
            ...
            <div style="max-width: 97%" class="mx-auto">
                <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Expedition Highlights</h2>
...
{{-- Expedition Iterinary --}}  
    ...
    <div class="mt-6" >
        ...
        <section class="bg-gray-100  mx-auto mt-8 p-9 "  id="itinerary">

        <div class=" mx-auto" style="max-width:95%" >
            <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Expedition Itirenary Overview</h2>
            <div class="flex items-center justify-center" style="max-width:95%" >
                <div class="w-full max-w-7xl">
                    <div class="bg-blue-800 text-white text-center my-6 p-6 rounded-t-lg">
                        <h1 class="text-3xl font-bold" style="font-family: 'Times New Roman', Times, serif">Mountains in Nepal – Iterinanary Overview</h1>
 ...
 {{-- Expedition Iterinary --}}
  ...
  <div class="container mx-auto py-20 px-8 bg-white rounded-lg shadow-lg mt-8" id="required" >
    <div class="mx-auto" style="max-width: 95%">
        ...
        <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Required Items for This Expedition</h2>
...
<div class="mt-6" >
    ...
    <section class="bg-gray-100 min-h-screen  mx-auto mt-8 p-9 "  id="faqs">
 
     <div class=" mx-auto" style="max-width:95%" >
        <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Expedition FAQ Overview</h2>
         
         <div class="flex items-center justify-center mx-auto" style="max-width:96%" >
             <div class="w-full max-w-7xl">
                 <div class="bg-blue-800 text-white text-center my-6 p-6 rounded-t-lg">
                     <h1 class="text-3xl font-bold" style="font-family: 'Times New Roman', Times, serif">Expeditions in Nepal – Mountain Faq Overview</h1>
                 ...
                 <div id="faq-container" class="bg-transparent   shadow-lg rounded-b-lg">
                     @foreach ($mountainfaqs as $mountainfaq)
                         <div class="border-b mb-4 last:mb-0">
                             ...
                             <div style="display: none;" class="px-4 pb-4 bg-white text-black" id="answer{{ $mountainfaq->id }}">
                             <p>{{ $mountainfaq->answer }}</p>
...
<div class="container mx-auto p-10  bg-gray-100 mt-10 rounded-lg shadow-lg"  id="reviews">
    ...
    @if ($mountainreviews->count() > 0)
            ...
            @foreach ($mountainreviews as $review)
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col justify-between h-full">
                    ...
                    <div class="mt-auto pt-4">
                        <form action="{{ route('mountainreviews.destroy', $review->id) }}" method="POST" 
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('mountainreviews.index', $mountain_id) }}" class="inline-block px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition duration-200 ease-in-out">
                View All Reviews
            </a>
        </div>
...
<div class="container mx-auto py-8 px-4 bg-gray-100 rounded-lg shadow-lg mt-10">
    <h2 class="text-3xl px-8 py-3 font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Give your Review for {{$mountain->name}}</h2>
