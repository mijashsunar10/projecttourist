    ...
    <div class="text-center  animate-fade-in-down">
        <h1 class="text-4xl font-bold text-gray-800 mb-2">
            <span class="bg-gradient-to-r from-blue-600 to-indigo-600 text-transparent bg-clip-text">
                🏔️ Add mountain to {{ $expedition->name }}
            </span>
        </h1>
        <p class="text-gray-600 text-lg">Add a new mountain with its details and an image</p>
    </div>
<div class=" relative container mx-auto mt-3 p-6 bg-white shadow-2xl rounded-xl max-w-3xl">
    <!-- Header Section -->
    <a href="{{ route('expeditionsshow',$expedition->id) }}" class="absolute top-2 right-2">
        <button
    ...
    <form action="{{ route('mountainsstore', $expedition->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="space-y-6">
            <!-- mountain Name Input -->
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">mountain Name</label>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" required
                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none"
                    placeholder="Enter mountain description"></textarea>
            </div>
            ...
            <div>
                ...
                <input type="number" name="price" id="price" required
                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none"
                    placeholder="Enter mountain price">
            </div>
            ...
            <div>
                ...
                <input type="number" name="duration" id="duration" required
                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none"
                    placeholder="Enter mountain duration">
            </div>
