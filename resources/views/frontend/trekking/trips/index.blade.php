...
<section class="bg-gray-100 mt-20 min-h-screen">
    ...
    <div class="max-w-[85%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-5 mt-8 ">
        ...
        @else
            ...
            <div class=" gallery-item rounded-xl overflow-hidden shadow-xl bg-white transition transform duration-300 hover:scale-105 relative ">
                ...
                <div class="p-6 ">
                    {{-- <h2 class="text-3xl font-bold text-gray-800 px-3 mb-3" style="font-family: 'Playfair Display', serif; letter-spacing:0.04ch; font-weight:bold; font-style: normal;">{{ $trip->name }}</h2> --}}
                    <h2 class="text-3xl font-bold text-blue-900 px-3 mb-3" style="font-family: 'Times New Roman', Times; font-weight:bold;" >{{ $trip->name }} Trek</h2>
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <div class=" text-[#0b3e85] rounded-full  py-1 font-medium text-md">
                            <span class=" bg-blue-100 px-3 py-2 rounded-full text-md font-semibold "> <i class="fas fa-calendar-alt mr-2"></i>  Duration: {{ $trip->duration }} days </span>
                        </div>
                        <div class=" text-[#0b3e85] rounded-full  py-1 font-medium text-md">
                            <span class=" bg-blue-100 px-3 py-2 rounded-full text-md font-semibold"> <i class="fas fa-mountain mr-2"></i>    Ascent: {{ $trip->ascent }} - 23 ascent/day </span>
                        </div>
                        <div class=" text-[#0b3e85] rounded-full  py-1 font-medium text-md">
                            <span class=" bg-blue-100 px-3 py-2 rounded-full text-md font-semibold"> <i class="fas fa-route mr-2"></i>  Distance: {{ $trip->distance }} - 48  kilometer/days </span>
                        </div>
                        {{-- <div class="bg-[#0b3e85] bg-opacity-10 text-[#0b3e85] rounded-full px-5 py-1 font-medium text-md">
                        </i> Distance: {{ $trip->distance }} km/day
                    </div> --}}
