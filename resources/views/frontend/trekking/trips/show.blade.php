...
{{-- New ....... --}}
    ...
    <div class="container mx-auto px-8 py-12 flex gap-6">
        ...
        <div class="w-4/5"  >
            ...
            <div id="tripfacts" class="container py-8 px-16 bg-white shadow-xl rounded-lg  mt-8 hover-scale">
                ...
                <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Trip Facts</h2>
            ...
            @auth
                <div class="mx-auto mt-8 p-12 bg-white rounded-lg shadow-xl" id="highlight" >
                    ...
                    <div style="max-width: 98%" class="mx-auto">
                        <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Trip Highlights</h2>
        ...
        @endguest
            ...
            <div class="mt-6" >
                ...
                <div >
                    <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Trip Itirenary Overview</h2>
                    <div class="flex items-center justify-center" style="max-width:95%" class="mx-auto">
                        <div class="w-full max-w-7xl">
                            <div class="bg-blue-900 text-white text-center my-6 p-6 rounded-t-lg" >
                                <h1 class="text-4xl font-bold" style="font-family: 'Times New Roman', Times, serif">Trekking in Nepal – Iterinanary Overview</h1>
    ...
    <div class="mt-6" >
        ...
        <div class=" mx-auto" style="max-width:96%" >
            <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">{{$trip->name}} FAQ Overview</h2>
            {{-- <h2 class="section-title"></h2> --}}
            <div class="flex items-center justify-center" style="max-width:95%" >
                <div class="w-full max-w-7xl">
                    <div class="bg-blue-900 text-white text-center my-6 p-6 rounded-t-lg">
                        <h1 class="text-3xl font-bold" style="font-family: 'Times New Roman', Times, serif"> FAQ Overview</h1>
    ...
    <div class="bg-gray-50 p-10 mt-6" id="reviews">
        <div class="">
            ...
            <div class="mt-8 text-center">
                <a href="{{ route('reviews.index', $trip_id) }}" class="inline-block px-6 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-600 transition duration-200 ease-in-out">
                    View All Reviews
                </a>
            </div>
