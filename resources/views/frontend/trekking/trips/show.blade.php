...
<div class="sticky top-20 z-10 bg-blue-200 shadow">
    <nav class="container flex justify-center items-center py-4 px-6">
        <ul class="flex space-x-16 text-gray-700">
            ...
            <li><a href="#highlight" class="nav-link hover:text-blue-600"> Highlights</a></li>
...
<div class="container mx-auto py-8 px-4 bg-gray-100 mt-10 rounded-lg shadow-lg" style="max-width: 90%" id="reviews">
    ...
    @if ($reviews->count() > 0)
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('reviews.index', $trip_id) }}" class="inline-block px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition duration-200 ease-in-out">
                View All Reviews
            </a>
        </div>
