...
@section('pagecontent')
    ...
    <div class="sticky top-20 z-10 bg-blue-800 shadow">
        ...
        <nav class="container flex justify-center items-center py-4 px-6">
            <ul class="flex space-x-16 text-white">
                ...
                <li><a href="#tripfacts" class="nav-link hover:text-gray-200">Trip Facts</a></li>
                ...
                <li> <a href="{{ route('regionsshow', $trip->region_id) }}"><button type="submit"
                            class="text-white  font-bold rounded-lg">Go back to trip</button></a></li>
            </ul>
        </nav>
                ...
                @auth
                    ...
                    <div class="absolute top-3 mt-4 right-4 flex gap-2">
                        ...
                        <div id="addImageModal"
                            class="fixed inset-0 z-10 bg-gray-900 bg-opacity-50 flex items-center justify-center hidden">
                            <!-- Modal Content -->
                            <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-lg relative">
                                ...
                                <!-- Add Image Form -->
                                <form action="{{ route('addtripimages', $trip->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-4">
                                        <label for="images" class="block text-gray-700 font-medium mb-2">Select Images</label>
                                        <input type="file" id="images" name="images[]"
                                            class="w-full border rounded px-4 py-2" multiple onchange="previewImages(event)">
                                    </div>
                                ...
                                Array.from(event.target.files).forEach((file, index) => {
                                    ...
                                    reader.onload = function(e) {
                                        ...
                                        closeButton.className =
                                            "absolute top-1 right-1 bg-red-500 text-white rounded-full h-6 w-6 flex items-center justify-center opacity-80 hover:opacity-100";
                        ...
                        @if ($trip->images->isNotEmpty())
                            <form action="{{ route('deleteimage', $trip->images->first()->id) }}" method="POST"
                ...
                @if ($trip->images->isNotEmpty())
                    <div class="flex flex-wrap gap-4 justify-center absolute bottom-16 w-full z-1 px-4">
                        @foreach ($trip->images as $image)
                            <img src="{{ asset('images/trips/' . $image->image) }}" alt="Thumbnail"
    ...
    <div class="container mx-auto px-8 py-12 flex gap-6">
        ...
        <div class="w-4/5">
            ...
            <div class="bg-white xl:p-12 p-8 rounded-lg shadow-lg mt-6" id="overview">
                <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">Trip
                    Overview</h2>
            ...
            <div id="tripfacts" class="container py-8 px-16 bg-white shadow-xl rounded-lg  mt-8 hover-scale">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
                    ...
                    @else
                        @foreach ($tripFacts as $fact)
                            <div class="flex items-center space-x-3">
                                <div>
                                    <svg width="54px" height="54px" viewBox="-2.4 -2.4 28.80 28.80" fill="none"
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            <path d="M12 8V12L14.5 14.5" stroke="#0B6285"
                                                stroke-width="1.8960000000000001" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path
                                                d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7"
                                                stroke="#0B6285" stroke-width="1.8960000000000001"
                            ...
                            <div class="flex items-center space-x-4">
                                <div>
                                    <svg fill="#0B6285" height="50px" width="50px" version="1.1" id="Capa_1"
                            ...
                            <div class="flex items-center space-x-3">
                                <div>
                                    <svg fill="#0B6285" width="54px" height="54px" viewBox="0 0 512 512"
                                        enable-background="new 0 0 512 512" id="airport" version="1.1"
                                        xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" stroke="#0B6285"
                            ...
                            <div class="flex items-center space-x-3">
                                <div>
                                    <svg width="70px" height="70px" viewBox="0 0 1024 1024" class="icon"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#0B6285"
                                        stroke="#0B6285" stroke-width="0.01024">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                            ...
                            <div class="flex items-center space-x-3">
                                <div>
                                    <svg fill="#0B6285" height="54px" width="54px" version="1.2" baseProfile="tiny"
                                        id="H1_1_" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-351 153 256 256"
                                        xml:space="preserve" stroke="#0B6285">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <g>
                            ...
                            <div class="flex items-center space-x-3">
                                <div>
                                    <svg fill="#0B6285" height="54px" width="54px" version="1.1" id="Layer_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            @auth
                                <div class="mt-2">
                                    ...
                                    <a href="{{ route('tripfactedit', [$trip->id, $fact->id]) }}">
                                        <button class="bg-yellow-500 text-white px-4 py-2 rounded">Edit Trip Facts</button>
                                    </a>
                                    <form action="{{ route('tripfactdestroy', [$trip->id, $fact->id]) }}" method="POST"
                                        class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded">Delete Trip
                                            Facts</button>
                                    </form>
                                </div>
                            @endauth
                ...
                <div class="mx-auto mt-8 p-12 bg-white rounded-lg shadow-xl" id="highlight">
                    ...
                    <div style="max-width: 98%" class="mx-auto">
                        <h2 class="text-3xl font-bold mb-4 text-blue-900"
                            style=" font-family: 'Times New Roman', Times, serif">Trip Highlights</h2>

                        <ul class="space-y-4">
                            @forelse ($highlights as $highlight)
                                <li
                                    class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-300">
                                    <span class="text-gray-700 font-medium">{{ $highlight->highlight }}</span>
                                    <form action="{{ route('tripHighlightsdestroy', $highlight->id) }}" method="POST"
                                        onsubmit="return confirm('Are you sure you want to delete this highlight?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            class="bg-red-500 text-white px-4 py-2 rounded-md text-sm hover:bg-red-600 transition-colors duration-300">
                                            Delete
                                        </button>
                                    </form>
                                </li>
                        ...
                        <div class="mt-6 flex space-x-4">
                            <a href="{{ route('tripHighlightsedit', $trip->id) }}"
                                class="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 transition-colors duration-300">
                                Edit Highlights
                            </a>
                            <a href="{{ route('tripHighlightscreate', $trip->id) }}"
                                class="bg-green-500 text-white px-6 py-2 rounded-md hover:bg-green-600 transition-colors duration-300">
                                Add Highlights
                            </a>
                        </div>
                    </div>
            ...
            @guest
                ...
                <div class="bg-gray-50 p-8 xl:p-12 rounded-lg shadow-lg" id="highlight">
                    <h2 class="text-3xl font-bold mb-4 text-blue-900" style=" font-family: 'Times New Roman', Times, serif">
                        Trip Highlights</h2>
                    <ul class="space-y-4 text-gray-700 text-lg font-semibold">
                        @forelse ($highlights as $highlight)
            ...
            <div class="mt-6">
                ...
                <section class="bg-gray-100 mx-auto mt-8 p-12 " id="itinerary">

                    <div>
                        <h2 class="text-3xl font-bold mb-4 text-blue-900"
                            style=" font-family: 'Times New Roman', Times, serif">Trip Itirenary Overview</h2>
                        <div class="flex items-center justify-center" style="max-width:95%" class="mx-auto">
                            <div class="w-full max-w-7xl">
                                <div class="bg-blue-900 text-white text-center my-6 p-6 rounded-t-lg">
                                    <h1 class="text-4xl font-bold" style="font-family: 'Times New Roman', Times, serif">
                                        Trekking in Nepal – Iterinanary Overview</h1>
                                    <p class="mt-2 text-lg">A detail description of Itirenary</p>

                                    @auth
                                        <a href="{{ route('itinerarycreate', $trip->id) }}">
                                            <button class="text-white font-bold mt-2 px-3 py-1 bg-[#374151] rounded-lg">Add
                                                FAQ</button>
                                        </a>
                                    @endauth
                                </div>
                                    ...
                                    @foreach ($itineraries as $itinerary)
                                        <div class="border-b mb-4 last:mb-0">
                                            <button
                                                ...
                                                onclick="toggleAnswer('answer{{ $itinerary->id }}')"
                                                aria-expanded="false">
                                                {{ $itinerary->question }}
                                            ...
                                            <div class="hidden px-4 pb-4 bg-white text-black"
                                                id="answer{{ $itinerary->id }}">
                                                <p>{{ $itinerary->answer }}</p>

                                                @auth

                                                    <div class="mt-2">
                                                        <a href="{{ route('itineraryedit', [$trip->id, $itinerary->id]) }}"
                                                            class="text-blue-500">
                                                            <button
                                                                class="text-white font-bold px-3 py-1 bg-[#0B6285] rounded-lg">Edit</button>
                                                        </a>
                                                        <form action="{{ route('itinerarydestroy', $itinerary->id) }}"
                                                            method="POST" class="inline-block">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="text-white font-bold mt-2 ml-2 px-3 py-1 bg-[#ff0000] rounded-lg">Delete</button>
                                                        </form>
                                                    </div>
                                                @endauth
                                            </div>
            ...
            <section id="required">
                <div class="container  py-20 px-8 bg-white rounded-lg shadow-lg mt-8" ">
                    ...
                    <div class="flex justify-between items-center border-b py-2">
                        <p class="text-gray-600 text-[1.2rem] font-semibold">&#10148; <span class="px-3">
                                {{ $item->item_name }}</span>
                        </p>
                        @auth
                            <div>
                                <a href="{{ route('requireditems.edit', [$trip->id, $item->id]) }}"
                                    class="bg-blue-500 text-white px-3 py-1 rounded">Edit</a>
                                <form action="{{ route('requireditems.destroy', [$trip->id, $item->id]) }}" method="POST"
                                    class="inline-block">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @auth
                        <a href="{{ route('requireditems.create', $trip->id) }}"
                            class="mt-6 inline-block bg-green-500 text-white px-4 py-2 rounded">Add Required Item</a>
                    @endauth
                </div>
        </div>
        <script>
        ...
        <div class="container py-12 px-12 bg-gray-100 mt-8" id="inclusions">
            ...
            @else
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="p-6 bg-white rounded-lg shadow-md">
                        <h3 class="text-xl font-bold text-gray-800 mb-4">Price Includes</h3>
                        @php
                        ...
                        @else
                            <ul class="space-y-3 text-gray-700 text-md font-semibold">
                                @foreach ($inclusions as $inclusion)
                                    <li>&#10148; {{ $inclusion->description }}
                                        ...
                                        @auth
                                            <a href="{{ route('trips.inclusions-exclusions.edit', [$trip->id, $inclusion->id]) }}"
                                                class="text-blue-500 ml-2">Edit</a>
                                            <form
                                                action="{{ route('trips.inclusions-exclusions.destroy', [$trip->id, $inclusion->id]) }}"
                            ...
                            <ul class="space-y-3 text-gray-600">
                                @foreach ($exclusions as $exclusion)
                                    <li>&#10148; {{ $exclusion->description }}
                                        ...
                                        {{-- Edit and Delete Actions --}}
                                        @auth
                                            <a href="{{ route('trips.inclusions-exclusions.edit', [$trip->id, $exclusion->id]) }}"
                                                class="text-blue-500 ml-2">Edit</a>
                                            <form
                                                action="{{ route('trips.inclusions-exclusions.destroy', [$trip->id, $exclusion->id]) }}"
                                                method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-red-500 ml-2">Delete</button>
            ...
            @auth
                <div class="mt-6 text-center">
                    <a href="{{ route('trips.inclusions-exclusions.create', $trip->id) }}"
                        class="bg-blue-500 text-white px-4 py-2 rounded shadow-md">Add Items</a>
                </div>
            @endauth
        </div>
        ...
        <div class="mt-6">
            ...
            <section class="bg-gray-100  mt-8 p-9 " id="faqs">

                <div class=" mx-auto" style="max-width:96%">
                    <h2 class="text-3xl font-bold mb-4 text-blue-900"
                        style=" font-family: 'Times New Roman', Times, serif">{{ $trip->name }} FAQ Overview</h2>
                    {{-- <h2 class="section-title"></h2> --}}
                    <div class="flex items-center justify-center" style="max-width:95%">
                        <div class="w-full max-w-7xl">
                            <div class="bg-blue-900 text-white text-center my-6 p-6 rounded-t-lg">
                                <h1 class="text-3xl font-bold" style="font-family: 'Times New Roman', Times, serif"> FAQ
                                    Overview</h1>
                                ...
                                @foreach ($tripfaqs as $tripfaq)
                                    <div class="border-b mb-4 last:mb-0">
                                        ...
                                        <div class="hidden px-4 pb-4 bg-white text-black" id="answer{{ $tripfaq->id }}">
                                            ...
                                            @auth
                                                <div class="mt-2">
                                                    <a href="{{ route('tripfaqedit', [$trip->id, $tripfaq->id]) }}"
                                                        class="text-blue-500">
                                                        <button
                                                            class="text-white font-bold px-3 py-1 bg-[#0B6285] rounded-lg">Edit</button>
                                                    </a>
            ...
            <script>
                function toggleAnswer(answerId) {
                    ...
                    const icon = document.getElementById(
                        `icon${answerId.replace('answer', '').replace('tourfaq-', '').replace('itinerary-', '')}`);
            ...
            <div class="bg-gray-50 p-10 mt-6" id="reviews">
                <div class="">
                    <h2 class="text-3xl font-bold mb-4 text-blue-900"
                        style=" font-family: 'Times New Roman', Times, serif">Latest Reviews of {{ $trip->name }}</h2>
                        ...
                        @foreach ($reviews as $review)
                            <div class="card-flip w-full h-80">
                                <div
                                    ...
                                    <!-- Back Side -->
                                    <div
                                        class="card-back absolute w-full h-full bg-white flex flex-col justify-center items-center text-center px-4 rounded-lg shadow-lg rotate-y-180 backface-hidden">
                                        <!-- Rating -->
                                        ...
                                        <form action="{{ route('reviews.destroy', $review->id) }}" method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="px-4 py-2 text-white bg-red-500 rounded-md hover:bg-red-600 transition duration-200 ease-in-out">
                                                Delete
                                            </button>
                                        </form>
                                    </div>
                    ...
                    <div class="mt-8 text-center">
                        <a href="{{ route('reviews.index', $trip_id) }}"
                            class="inline-block px-6 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-600 transition duration-200 ease-in-out">
                            View All Reviews
                        </a>
                    </div>
            ...
            <div class="container  py-8 px-4 bg-gray-100 rounded-lg shadow-lg mt-10">
                <h2 class="text-3xl px-8 py-3 font-bold mb-4 text-blue-900"
                    style=" font-family: 'Times New Roman', Times, serif">Give your Review for {{ $trip->name }}</h2>
                <form action="{{ route('reviews.store', $trip->id) }}" method="POST" enctype="multipart/form-data"
                    class="bg-white mx-auto p-8 rounded-lg shadow-md" style="max-width:95%">
                    @csrf
                    ...
                    <div class="mt-6" x-data="{ rating: 0 }">
                        ...
                        <div class="flex space-x-2 text-yellow-500 text-3xl cursor-pointer">
                            <template x-for="star in 5">
                                <span @click="rating = star" :class="rating >= star ? 'text-yellow-500' : 'text-gray-300'"
                    ...
                    <div class="mt-6 text-center">
                        <button type="submit"
                            class="px-8 py-3 bg-blue-800 text-white rounded-lg hover:bg-blue-600 transition duration-200 ease-in-out">
                            Submit Review
                        </button>
                    </div>
                </form>
    ...
    <div class="w-1/5 sticky top-40 h-max">
        <div class="bg-white p-6 rounded-lg shadow-xl">
            <h2 class="text-2xl font-bold  text-blue-1000" style=" font-family: 'Times New Roman', Times, serif">Trip Cost
            </h2>
            <p class="text-lg font-bold text-red-600">USD 1,200 per person</p>
            <div class="space-y-3 mt-4">
                <a href="{{ route('booking', $trip->id) }}"
                    class="block bg-blue-800 text-white text-center py-3 rounded-md hover:bg-blue-700 transition font-bold">
                    Book Now
                ...
                <a href="{{ route('customize') }}"
                    class="block bg-gray-700 text-white text-center py-3 rounded-md hover:bg-indigo-600 transition font-bold">
                    Customize Now
