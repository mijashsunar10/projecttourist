    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto p-4">
        <a href="{{ route('trekinfo') }}">
            ...
            <div class="relative overflow-hidden rounded-lg shadow-lg group h-96">
              <img src="{{ asset('frontend/images/mountain.png') }}" alt="Everest Region" class="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-125 group-hover:brightness-75 brightness-50">
