...
<div class="max-w-4xl mx-auto mt-20 px-4">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 md:p-8 relative">
        ...
        <h1 class="text-xl sm:text-3xl font-bold text-blue-700 text-center mb-6">Add Itinerary for "{{ $trip->name }}"</h1>

        <form action="{{ route('itinerarystore', $trip->id) }}" method="POST" class="space-y-6">
            @csrf
