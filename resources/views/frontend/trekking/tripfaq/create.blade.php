...
<div class="container mx-auto mt-24 px-4">
    <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-6 md:p-8">
        <h1 class="text-3xl font-semibold text-gray-800 mb-6 text-center">Add Trip FAQ for "{{ $trip->name }}"</h1>

        <form action="{{ route('tripfaqstore', $trip->id) }}" method="POST" class="space-y-5">
            @csrf
