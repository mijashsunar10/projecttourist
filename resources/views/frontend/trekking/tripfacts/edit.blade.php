...
<div class="container mx-auto py-12 px-6 md:px-12 bg-white shadow-xl rounded-2xl mt-12">
    <h2 class="text-4xl font-extrabold text-blue-700 text-center mb-8">✏️ Edit Trip Fact for {{ $trip->name }}</h2>
    
    <form action="{{ route('tripfactupdate', [$trip->id, $fact->id]) }}" method="POST" class="space-y-8">
        @csrf
