...
@section('pagecontent')
    ...
    <div class="bg-gray-50">
        ...
        <!-- trip facts-->
        <div id="tripfacts" class="container mx-auto py-8 px-16 bg-white shadow-md rounded-lg  mt-8"  style="max-width: 90%;">
        ...
        <!-- Itinerary Section -->
        <div class="container mx-auto py-20 px-8 bg-gray-50 rounded-lg shadow-lg mt-8 hover-scale" id="itinerary" style="max-width: 90%;">
        ...
        <script>
            ...
            function renderFAQs() {
                ...
                <div class="border-b  mb-4 last:mb-0">
                    <button
                        class="w-full flex justify-between items-center text-left p-4 text-lg font-semibold text-orange-800 bg-white  focus:outline-none shadow-2xl"
