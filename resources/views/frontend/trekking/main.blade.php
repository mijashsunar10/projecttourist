...
<div class="bg-gray-50">
    ...
    <div id="tripfacts" class="container mx-auto py-8 px-16 bg-white shadow-md rounded-lg  mt-8">
        <h2 class="text-3xl font-bold text-blue-700 mb-6">Trip Facts</h2>
    ...
    <div class="container mx-auto py-16 px-16 bg-white shadow-md rounded-lg  mt-8" id="overview"
        style="max-width: 90%;">
        <h2 class="text-3xl font-bold text-blue-700 mb-6">Overview</h2>
    ...
    <div class="container mx-auto py-16 px-16 bg-gray-100 shadow-md rounded-lg  mt-8" id="highlight"
        style="max-width: 90%;">
        <h2 class="text-3xl font-bold text-blue-700 mb-6">Trip Highlights</h2>
    ...
    <!-- Pricing Section -->
    <div class="mt-8 py-16 flex items-center justify-center bg-yellow-100" id="pricing">
