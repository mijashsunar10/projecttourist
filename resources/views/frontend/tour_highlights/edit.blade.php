...
<div class="container mx-auto mt-10">
    <h1 class="text-2xl font-bold mb-4">Edit Highlights for "{{ $tourtrip->name }}"</h1>
        ...
        <div id="highlight-container" class="space-y-4">
            @foreach ($highlights as $highlight)
                <div class="flex items-center space-x-2">
                    <textarea name="tourhighlights[{{ $highlight->id }}]" class="w-full border rounded px-4 py-2">{{ $highlight->highlight }}</textarea>
