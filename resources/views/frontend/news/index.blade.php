    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:-translate-y-2 hover:shadow-2xl">
                <img class="w-full h-80 object-contain" src="{{ asset('images/news/'.$new->image)}}" alt="Web Development">
                <div class="p-5">
                    ...
                    <div class="flex items-center mt-4">
                        <img class="w-8 h-8 rounded-full" src="{{ asset('images/news/'.$new->image)}}" alt="John Smith">
                        <div class="ml-3">
