...
<!-- Gallery Container -->
<div class=" p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 shadow-xl" id="gallery-container">
...
<script>
    ...
    // Ensure fullscreen overlay is visible
     ...
     // Populate the gallery container
        sortedItems.forEach((item, index) => {
            ...
            <div class=" rounded-lg overflow-hidden shadow-md bg-white hover-effect cursor-pointer" data-index="${index}">
                <img src="${item.url}" alt="${item.title}" class="w-full h-60 object-contain">
