...
<div class="bg-gray-100 p-6 mt-16">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <!-- Form Title -->
        <h2 class="text-xl font-semibold mb-2">Add New News</h2>
        <p class="text-gray-500 mb-6">Create and publish your news article</p>

        <!-- Article Form -->
        
        <form class="space-y-6" enctype="multipart/form-data" method="POST" action="{{ route('savenews') }}">
            <!-- Article Title -->
            @csrf
            ...
            <div class="flex justify-end">
                    ...
                    <button  type="submit"
                        class="bg-blue-600 text-white px-6 py-3 rounded-md shadow hover:bg-blue-700 transition-all">
                        Publish Article
                    </button>
