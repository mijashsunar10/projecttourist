...
@section('pagecontent')
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8 pt-28">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                <div class="relative h-48 overflow-hidden">
                    <img src="{{ asset('uploads/blogs/images/'.$blog->image )}}" alt="{{ $blog -> image}}" class="w-full h-full object-cover transform hover:scale-110 transition-transform duration-500">
