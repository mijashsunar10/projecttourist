...
<section class="bg-gray-200 mt-20">
    <div class="flex flex-col items-center justify-center ">
        ...
        <div class="mt-4 flex gap-4 ">
            ...
            @endauth
            <a href="{{ route('tourindex') }}" class="bg-red-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-red-600 transition duration-300 shadow-md">
                Return to tours
            </a>
        </div>
            ...
            <div class="gallery-item rounded-xl overflow-hidden shadow-xl bg-white transition transform duration-300 hover:scale-105">
                ...
                <div class="p-6 ">
                    ...
                    <div class="mt-4 space-y-2">
                        <a href="" class="block bg-[#0B6285] text-white py-2 px-4 rounded-lg w-full text-center hover:bg-[#094A6B] font-medium transition-colors duration-300 shadow-md">
                            View Details
                        </a>
