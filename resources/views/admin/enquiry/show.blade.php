    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative mb-8">
            ...
            <a href="{{ route('admin.enquiry.index') }}"
             ...
             <!-- Delete Button -->
             <form action="{{ route('admin.enquiry.destroy', $enquiry->id) }}" method="POST" class="absolute top-0 right-16">
                @csrf
                @method('DELETE')
                <button type="submit"
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $enquiry->name }}</dd>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="mt-1 text-lg font-semibold text-gray-900 break-all">{{ $enquiry->email }}</dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-white rounded-xl border border-gray-200 hover:border-purple-500 transition-all duration-200">
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $enquiry->country }}</dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-white rounded-xl border border-gray-200 hover:border-indigo-500 transition-all duration-200">
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $enquiry->trip->name}}</dd>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $enquiry->phone }}</dd>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <p class="text-gray-800 leading-relaxed whitespace-pre-line">{{ $enquiry->message }}</p>
                    </div>
                </div>
            </div>
        </div>
