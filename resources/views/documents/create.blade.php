...
<div class="container mx-auto mt-20 p-6 bg-white shadow-lg rounded-xl max-w-2xl">
    ...
    <div class="text-center mb-6 animate-fade-in-down">
        ...
        <p class="text-gray-600">Upload and manage legal documents easily</p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <select name="category" required
                    ...
                    <option value="travel_association">Travel Associations</option>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Upload Document Image</label>
